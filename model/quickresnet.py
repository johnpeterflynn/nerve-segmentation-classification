...
from model import ResUltNet

class QuickResNet(BaseModel):
    """
    ...
    def __init__(self, params):
        ...
        self.resultnet = ResUltNet(params) # TODO: Is it right to pass params here too?
