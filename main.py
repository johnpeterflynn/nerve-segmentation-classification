...
#                        loss = criterion(outputs, labels.long(), weights)   
                ...
                if phase == "val":
                    ...
                    print('val__loss_per_epoch: ', ep_lo_va) 
                    print('val__dice_score_per_epoch: ', dice_metric_per_ep)
                ...
                if phase == "train":
                    ...
                    print('train__loss_per_epoch: ', ep_lo_tr)
                    print('train__dice_score_per_epoch: ', dice_metric_per_ep)
